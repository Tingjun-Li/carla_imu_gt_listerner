...
public:
  ...
  void ImuCallback(const sensor_msgs::Imu& imu_msg)
  {
    ...
    imu_with_noise_msg.angular_velocity.x += gyro_noise(generator);
    imu_with_noise_msg.angular_velocity.y += gyro_noise(generator);
    imu_with_noise_msg.angular_velocity.z += gyro_noise(generator);

    imu_with_noise_msg.linear_acceleration = imu_msg.linear_acceleration;
    imu_with_noise_msg.linear_acceleration.x += acc_noise(generator);
    imu_with_noise_msg.linear_acceleration.y += acc_noise(generator);
    imu_with_noise_msg.linear_acceleration.z += acc_noise(generator);
